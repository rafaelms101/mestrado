 ...
 */
 ...
 __declspec(target(mic)) static void add_matmul (FINTEGER d, FINTEGER na, FINTEGER nb,
 ...
 */
 ...
 __declspec(target(mic)) void compute_cross_distances (int d, int na, int nb,
...
__declspec(target(mic)) void compute_cross_distances_nonpacked (int d, int na, int nb,
