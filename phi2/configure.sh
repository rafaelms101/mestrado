...
cflags="-fPIC -Wall -g -O3  -L/opt/intel/compilers_and_libraries_2017.1.132/linux/mkl/lib/intel64_lin/ -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -lpthread -ldl $CFLAGS"
